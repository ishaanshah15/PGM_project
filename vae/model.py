...
class VecEncoder(nn.Module):
    def __init__(self, input_dim, latent_dim):
        ...
        self.fc1 = nn.Linear(self.input_dim,8*self.input_dim)
        self.fc2 = nn.Linear(8*self.input_dim,16*self.input_dim)
        self.fc3 = nn.Linear(16*self.input_dim,8*self.input_dim)
        self.fc4 = nn.Linear(8*self.input_dim,self.latent_dim)
...
class VecDecoder(nn.Module):
    def __init__(self, input_dim, latent_dim):
        ...
        self.fc1 = nn.Linear(self.latent_dim,8*self.input_dim)
        self.fc2 = nn.Linear(8*self.input_dim,16*self.input_dim)
        self.fc3 = nn.Linear(16*self.input_dim,8*self.input_dim)
        self.fc4 = nn.Linear(8*self.input_dim,self.input_dim)
...
class ActionAEModel(nn.Module):
    def __init__(self, latent_dim=6, input_dim=30):
        super().__init__()
        self.latent_dim = latent_dim
        self.input_dim = input_dim

        self.encoder = VecEncoder(input_dim, latent_dim)
        self.decoder = VecDecoder(input_dim, latent_dim)
    #NOTE: You don't need to implement a forward function for AEModel. For implementing the loss functions in train.py, call model.encoder and model.decoder directly.
